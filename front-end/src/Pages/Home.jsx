                ...
                <div className="col  col-lg-3 col-xl-2  col-sm-4 order-2">
                    <ul className="nav">
                        ...
                        <li className="nav-item">
                            ...
                            href="#" 
                            onClick={()=>{onSelectTab(1,'breaking')}}
                            >Populare</a>
                        </li>
                    </ul>
                    <div className="container-fluid p-0  ">
                    <NewsFeedTemplate requestUrl={tabNews} type='sidebar'></NewsFeedTemplate>
                    </div>
                </div>
                <div className="col-lg-6 col-sm-4 order-2">
                <NewsFeedTemplate requestUrl={'http://localhost:3001/breaking'} type='main'></NewsFeedTemplate>
                </div>

                <div className="col col-lg-4 col-sm-4 order-3 " style={{backgroundColor:'#FFFCDF'}}>
                <NewsFeedTemplate requestUrl={'http://localhost:3001/recommended'} type='recommended'></NewsFeedTemplate>
                </div>
            </div>
        </div>
    )
